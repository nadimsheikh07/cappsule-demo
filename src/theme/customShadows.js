...
function createShadow(color) {
  ...
  return {
    ...
    searchBar: `0px 0px 50px 0px ${palette("light").grey[1000]}`,
    cappsuleShadow: `0px 0px 30px 0px ${palette("light").customColor[0]}`,
    chipShadow: `0px 0px 11.54px 0px ${palette("light").primary.shadow}`,
  };
}
